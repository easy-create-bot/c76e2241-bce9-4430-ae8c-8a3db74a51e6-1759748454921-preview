...
function  Header({ scrollToQuote }:{ scrollToQuote:()=>void }) { return <motion.header className="relative w-full flex flex-col px-6 h-[250px] sm:h-[300px] items-center justify-center"><img src="/header.png" className="absolute top-0 left-0 w-full h-full object-cover img-blur"/><motion.div className="z-20 flex flex-col items-center text-white"><motion.h1 variants={itemVariants} className="text-4xl sm:text-6xl font-header text-green-500">Jace Genereux</motion.h1><motion.span variants={itemVariants} className="text-2xl sm:text-3xl md:text-4xl font-body text-center">Bring your website idea to life</motion.span><motion.button whileHover={{ scale:1.04 }} variants={itemVariants} onClick={scrollToQuote} className="cursor-pointer relative inline-flex items-center justify-center px-2 md:px-4 py-1 md:py-2 rounded-full font-nav text-xl sm:text-2xl md:text-3xl font-semibold text-white bg-white/10 border border-white/30 backdrop-blur-xs shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:bg-white/20 hover:border-white/50 hover:shadow-[0_12px_40px_rgba(124,58,237,0.0)]">Get Quote</motion.button></motion.div></motion.header> }
